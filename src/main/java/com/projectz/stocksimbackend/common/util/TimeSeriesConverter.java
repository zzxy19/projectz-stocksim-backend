...
public class TimeSeriesConverter {
  ...
  public static TimeSeriesProto convertTimeSeriesResponseToProto(
    ...
    //set up meta date
    timeSeriesProto.setSymbol(getFromMap(metaData, SYMBOL_FIELD));
    timeSeriesProto.setInterval(getFromMap(metaData, INTERVAL_FIELD));
    timeSeriesProto.setLastRefreshed(getFromMap(metaData, LR_FIELD));
